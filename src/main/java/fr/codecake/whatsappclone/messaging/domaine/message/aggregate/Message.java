...
import fr.codecake.whatsappclone.messaging.domaine.message.vo.*;
...
public class Message {
    ...
    public Message(MessageSentTime sentTime, MessageContent content,
        ...
        asserMandatoryFields(sentTime, content, sendState, publicId, sender, conversationId);
    ...
    private void asserMandatoryFields(MessageSentTime sentTime,
